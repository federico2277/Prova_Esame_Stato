...
CREATE TABLE `flora` (
  `ID_Flora` int NOT NULL AUTO_INCREMENT,
  `Flora_tipo` varchar(50) DEFAULT NULL,
  `ID_Parco` int DEFAULT NULL,
  PRIMARY KEY (`ID_Flora`),
  KEY `ID_Parco` (`ID_Parco`),
  CONSTRAINT `flora_ibfk_1` FOREIGN KEY (`ID_Parco`) REFERENCES `parco` (`ID_Parco`)
...
INSERT INTO `flora` VALUES (1,'Arbusto',1),(2,'Albero',1),(3,'Piane_Erbacee',1);
